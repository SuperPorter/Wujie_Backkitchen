package com.txd.hzj.wujie_backkitchen.UI.Activity.BookingDatails;
 ...
 * <br>功能描述：预定详情界面
 */
public class BookingDetailsActivity extends MvpActivity<BookingDatailsPresenter> implements BookingDatailsContract.View{
    ...
    @Override
    protected BookingDatailsPresenter createPresenter() {
        return new BookingDatailsPresenter();
    }
