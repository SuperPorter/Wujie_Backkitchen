...
import com.txd.hzj.wujie_backkitchen.UI.Fragent.AllFragment;
import com.txd.hzj.wujie_backkitchen.UI.Fragent.Destine_Fragment;
import com.txd.hzj.wujie_backkitchen.UI.Fragent.Estimate_Fragment;
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    ...
                    {
                        //制作
                        FragmentManager.replaceFragment(getSupportFragmentManager(), allFragment, R.id.hoem_main_fragment, true);
                        break;
                    }
